...
function getIsraelTimezoneOffset(date: Date): string {
  ...
  // December is always standard time (UTC+2)
  // For safety, if we get an unexpected value, default to UTC+2
  if (offset !== 2 && offset !== 3) {
    console.warn(`Unexpected Israel timezone offset: ${offset}, defaulting to +2`);
    offset = 2;
  }
 ...
 */
export function prependTimeContext(message: string): string {
